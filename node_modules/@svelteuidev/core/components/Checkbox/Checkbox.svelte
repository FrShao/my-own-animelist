...
export let use = [], element = undefined, className = '', override = {}, color = 'blue', id = randomID(), disabled = false, value = null, checked = false, indeterminate = false, label = null, radius = 'sm', size = 'md', transitionDuration = 100;
