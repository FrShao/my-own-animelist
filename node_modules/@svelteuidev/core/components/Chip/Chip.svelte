...
export let use = [], element = undefined, className = '', override = {}, color = 'blue', id = randomID(), disabled = false, value = null, checked = false, label = '', radius = 'xl', size = 'sm', variant = 'outline', transitionDuration = 100;
