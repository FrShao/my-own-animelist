...
export declare type ProviderStyles = Record<string, Record<string, CSS> | ((theme: SvelteUITheme, params: Record<string, any>) => Record<string, CSS>)>;
export declare type SvelteUIDefaultProps = Record<string, Record<string, any>>;
...
export declare const ssrStyles: (fn: () => string) => string;
