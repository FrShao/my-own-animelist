...
import type { SvelteUIColor, SvelteUINumberSize, DefaultProps } from '../../styles';
...
export declare function getVariantStyles(color: SvelteUIColor, variant: ActionIconVariant): import("../../styles").VariantThemeFunction;
declare const _default: (params?: ActionIconStylesParams, options?: import("../../styles/engine/create-styles").UseStylesOptions<"root" | "variants">) => {
    cx: (...args: import("../../styles/engine/css").ArgumentArray) => string;
    theme: import("../../styles").SvelteUITheme;
    classes: Record<"root" | "variants", string>;
