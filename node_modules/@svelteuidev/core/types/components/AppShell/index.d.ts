...
export type { HorizontalSectionSharedProps, HorizontalSectionProps, HorizontalSectionPosition, HorizontalSectionWidth } from './HorizontalSection/HorizontalSection.styles';
export type { VerticalSectionSharedProps, VerticalSectionProps, VerticalSectionPosition } from './VerticalSection/VerticalSection.styles';
