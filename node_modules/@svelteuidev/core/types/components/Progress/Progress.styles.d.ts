import type { DefaultProps, SvelteUINumberSize, SvelteUIColor, ColorShades } from '../../styles';
...
export declare function getCumulativeSections(sections: Sections[]): AccumulatedSection[];
...
declare const _default: (params?: ProgressStylesParams, options?: import("../../styles/engine/create-styles").UseStylesOptions<"root" | "label" | "bar">) => {
