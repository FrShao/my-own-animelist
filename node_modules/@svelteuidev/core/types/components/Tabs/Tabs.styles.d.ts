...
import type { DefaultProps, SvelteUINumberSize, SvelteUIColor, SvelteUITheme, VariantThemeFunction } from '../../styles';
export declare type TabsContext = Writable<{
    active: number;
    color: SvelteUIColor;
    variant: TabsVariant;
...
export declare const getVariantStyles: (orientation: 'horizontal' | 'vertical', theme: SvelteUITheme) => VariantThemeFunction;
declare const _default: (params?: TabsStyleParams, options?: import("../../styles/engine/create-styles").UseStylesOptions<"content" | "root" | "wrapper" | "tabs">) => {
    cx: (...args: import("../../styles/engine/css").ArgumentArray) => string;
    theme: SvelteUITheme;
    classes: Record<"content" | "root" | "wrapper" | "tabs", string>;
