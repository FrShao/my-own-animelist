...
import type { DefaultProps, SvelteUIColor, SvelteUITheme, VariantThemeFunction } from '../../../styles';
...
export declare const getVariantStyles: (color: SvelteUIColor, orientation: 'horizontal' | 'vertical', theme: SvelteUITheme) => VariantThemeFunction;
declare const _default: (params?: TabStyleParams, options?: import("../../../styles/engine/create-styles").UseStylesOptions<"icon" | "root" | "label" | "inner" | "tabContent">) => {
    cx: (...args: import("../../../styles/engine/css").ArgumentArray) => string;
    theme: SvelteUITheme;
    classes: Record<"icon" | "root" | "label" | "inner" | "tabContent", string>;
