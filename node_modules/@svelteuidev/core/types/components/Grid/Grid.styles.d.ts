...
import type { CSS, DefaultProps, SvelteUINumberSize } from '../../styles';
export declare type GridContext = Writable<{
    cols: number;
    grow: boolean;
...
declare const _default: (params?: GridStyleParams, options?: import("../../styles/engine/create-styles").UseStylesOptions<"root">) => {
