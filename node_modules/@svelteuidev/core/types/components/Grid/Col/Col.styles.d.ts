import type { DefaultProps, SvelteUINumberSize, SvelteUITheme } from '../../../styles';
...
declare const _default: (params?: ColStyleParams, options?: import("../../../styles/engine/create-styles").UseStylesOptions<"root">) => {
