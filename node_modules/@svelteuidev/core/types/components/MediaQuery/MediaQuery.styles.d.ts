import type { DefaultProps, SvelteUINumberSize, CSS } from '../../styles';
...
declare const _default: (params?: MediaQueryStylesParams, options?: import("../../styles/engine/create-styles").UseStylesOptions<"root">) => {
