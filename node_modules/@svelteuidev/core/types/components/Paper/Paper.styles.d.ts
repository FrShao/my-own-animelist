import type { DefaultProps, SvelteUIShadow, SvelteUINumberSize } from '../../styles';
...
declare const _default: (params?: PaperStyleParams, options?: import("../../styles/engine/create-styles").UseStylesOptions<"root">) => {
