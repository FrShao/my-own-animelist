...
declare const _default: (params?: ChipStyleParams, options?: import("../../styles/engine/create-styles").UseStylesOptions<"input" | "root" | "label" | "iconWrapper" | "checkIcon" | "inputContainer">) => {
    cx: (...args: import("../../styles/engine/css").ArgumentArray) => string;
    theme: import("../../styles").SvelteUITheme;
    classes: Record<"input" | "root" | "label" | "iconWrapper" | "checkIcon" | "inputContainer", string>;
