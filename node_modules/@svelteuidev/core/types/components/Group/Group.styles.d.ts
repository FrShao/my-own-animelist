import type { DefaultProps, CSS, SvelteUINumberSize } from '../../styles';
...
declare const _default: (params?: GroupStylesParams, options?: import("../../styles/engine/create-styles").UseStylesOptions<"root">) => {
