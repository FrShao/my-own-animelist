...
import type { Override, SvelteUINumberSize, SvelteUISize } from '../../styles';
...
export declare type Formatter = (value: string | undefined) => string;
export declare type Parser = (value: string | undefined) => string | undefined;
...
declare const _default: (params?: NumberInputStyleParams, options?: import("../../styles/engine/create-styles").UseStylesOptions<"root" | "control">) => {
    cx: (...args: import("../../styles/engine/css").ArgumentArray) => string;
    theme: import("../../styles").SvelteUITheme;
    classes: Record<"root" | "control", string>;
