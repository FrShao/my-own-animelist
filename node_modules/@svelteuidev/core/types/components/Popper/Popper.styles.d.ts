...
import type { TransitionName, TransitionOptions } from '../../internal';
...
export declare type Transition = TransitionName | ((node: Element, params: TransitionParams) => TransitionConfig);
...
export declare function calculateArrowPlacement(arrowSize: any, arrowDistance: any, position: any, placement: any): {
    top: string;
    bottom: string;
    left: string;
    right: string;
};
declare const _default: (params?: PopperStyleParams, options?: import("../../styles/engine/create-styles").UseStylesOptions<"root" | "arrowStyles">) => {
    cx: (...args: import("../../styles/engine/css").ArgumentArray) => string;
    theme: import("../../styles").SvelteUITheme;
    classes: Record<"root" | "arrowStyles", string>;
