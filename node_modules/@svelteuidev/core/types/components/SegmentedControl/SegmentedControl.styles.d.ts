import type { DefaultProps, SvelteUIColor, SvelteUINumberSize, SvelteUISize } from '../../styles';
...
declare const _default: (params?: SegmentedControlStylesParams, options?: import("../../styles/engine/create-styles").UseStylesOptions<"input" | "root" | "disabled" | "label" | "control" | "active" | "controlActive" | "labelActive">) => {
    cx: (...args: import("../../styles/engine/css").ArgumentArray) => string;
    theme: import("../../styles").SvelteUITheme;
    classes: Record<"input" | "root" | "disabled" | "label" | "control" | "active" | "controlActive" | "labelActive", string>;
