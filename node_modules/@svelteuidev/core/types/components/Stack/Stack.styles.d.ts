import type { SvelteUINumberSize, DefaultProps, CSS } from '../../styles';
...
declare const _default: (params?: StackStyleParam, options?: import("../../styles/engine/create-styles").UseStylesOptions<"root">) => {
