import type { SvelteUIColor, SvelteUINumberSize } from '../../styles';
...
declare const _default: (params?: TooltipStyleParams, options?: import("../../styles/engine/create-styles").UseStylesOptions<"root" | "body" | "arrow">) => {
    cx: (...args: import("../../styles/engine/css").ArgumentArray) => string;
    theme: import("../../styles").SvelteUITheme;
    classes: Record<"root" | "body" | "arrow", string>;
