...
import type { DefaultProps, SvelteUINumberSize, SvelteUIColor } from '../../styles';
export declare type TimelineContext = Writable<{
    active: number;
    lineActive: boolean;
...
declare const _default: (params?: TimelineStyleParams, options?: import("../../styles/engine/create-styles").UseStylesOptions<"root">) => {
