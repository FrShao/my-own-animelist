...
export declare type TimelineItemVariant = 'dashed' | 'dotted' | 'solid';
...
declare const _default: (params?: TimelineItemStyleParams, options?: import("../../../styles/engine/create-styles").UseStylesOptions<"content" | "root" | "title" | "bullet" | "bulletContainer" | "bulletContainerWithChild" | "container">) => {
    cx: (...args: import("../../../styles/engine/css").ArgumentArray) => string;
    theme: import("../../../styles").SvelteUITheme;
    classes: Record<"content" | "root" | "title" | "bullet" | "bulletContainer" | "bulletContainerWithChild" | "container", string>;
