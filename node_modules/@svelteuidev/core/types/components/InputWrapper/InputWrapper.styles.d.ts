import type { DefaultProps, SvelteUISize } from '../../styles';
...
declare const _default: (params?: InputWrapperStyleParams, options?: import("../../styles/engine/create-styles").UseStylesOptions<"error" | "root" | "label" | "description" | "required">) => {
    cx: (...args: import("../../styles/engine/css").ArgumentArray) => string;
    theme: import("../../styles").SvelteUITheme;
    classes: Record<"error" | "root" | "label" | "description" | "required", string>;
