import type { Component, TransitionName, TransitionOptions } from '../../internal';
import type { DefaultProps, SvelteUINumberSize, SvelteUIShadow } from '../../styles';
...
export declare function getNextItem(active: number, items: HTMLButtonElement[]): number;
export declare function findInitialItem(items: HTMLButtonElement[]): number;
export declare function getPreviousItem(active: number, items: HTMLButtonElement[]): number;
declare const _default: (params?: MenuStyleParams, options?: import("../../styles/engine/create-styles").UseStylesOptions<"root" | "label" | "arrow" | "svelteui-Menu-body">) => {
    cx: (...args: import("../../styles/engine/css").ArgumentArray) => string;
    theme: import("../../styles").SvelteUITheme;
    classes: Record<"root" | "label" | "arrow" | "svelteui-Menu-body", string>;
