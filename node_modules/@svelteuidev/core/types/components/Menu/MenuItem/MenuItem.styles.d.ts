...
export declare function getContextItemIndex(options: {
    elementSelector: string;
    parentClassName: string;
}, node: HTMLElement): number;
declare const _default: (params?: MenuItemStylesParams, options?: import("../../../styles/engine/create-styles").UseStylesOptions<"root" | "itemInner" | "itemBody" | "itemIcon" | "itemLabel">) => {
    cx: (...args: import("../../../styles/engine/css").ArgumentArray) => string;
    theme: import("../../../styles").SvelteUITheme;
    classes: Record<"root" | "itemInner" | "itemBody" | "itemIcon" | "itemLabel", string>;
