import type { DefaultProps, SvelteUIColor } from '../../styles';
...
declare const _default: (params?: TypographyProviderStyleParams, options?: import("../../styles/engine/create-styles").UseStylesOptions<"root">) => {
