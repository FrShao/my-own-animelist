...
declare const _default: (params?: CheckboxStyleParams, options?: import("../../styles/engine/create-styles").UseStylesOptions<"input" | "icon" | "root" | "label" | "inner" | "iconWrapper">) => {
    cx: (...args: import("../../styles/engine/css").ArgumentArray) => string;
    theme: import("../../styles").SvelteUITheme;
    classes: Record<"input" | "icon" | "root" | "label" | "inner" | "iconWrapper", string>;
