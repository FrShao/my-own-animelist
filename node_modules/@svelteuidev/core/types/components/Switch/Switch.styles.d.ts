import type { DefaultProps, Override, SvelteUIColor, SvelteUINumberSize } from '../../styles';
...
export declare type SwitchTimingFunction = 'linear' | 'ease' | 'ease-in' | 'ease-out' | 'ease-in-out' | 'step-start' | 'step-end';
...
declare const _default: (params?: SwitchStyleParams, options?: import("../../styles/engine/create-styles").UseStylesOptions<"input" | "root" | "label">) => {
    cx: (...args: import("../../styles/engine/css").ArgumentArray) => string;
    theme: import("../../styles").SvelteUITheme;
    classes: Record<"input" | "root" | "label", string>;
