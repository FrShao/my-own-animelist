...
export declare type HTMLHeadingElements = 'h1' | 'h2' | 'h3' | 'h4' | 'h5' | 'h6';
...
declare const _default: (params?: void, options?: import("../../styles/engine/create-styles").UseStylesOptions<"root">) => {
