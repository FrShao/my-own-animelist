...
declare const _default: (params?: NotificationStylesParams, options?: import("../../styles/engine/create-styles").UseStylesOptions<"content" | "icon" | "root" | "title" | "closeButton" | "description" | "loader">) => {
    cx: (...args: import("../../styles/engine/css").ArgumentArray) => string;
    theme: import("../../styles").SvelteUITheme;
    classes: Record<"content" | "icon" | "root" | "title" | "closeButton" | "description" | "loader", string>;
