import type { DefaultProps, SvelteUINumberSize, SvelteUIColor, SvelteUIGradient, VariantThemeFunction } from '../../styles';
...
export declare type ThemeIconVariant = 'filled' | 'light' | 'gradient' | 'outline' | 'subtle' | 'default' | 'white';
...
export declare function getVariantStyles(color: SvelteUIColor, variant: ThemeIconVariant, gradient: SvelteUIGradient): VariantThemeFunction;
declare const _default: (params?: ThemeIconStyleParams, options?: import("../../styles/engine/create-styles").UseStylesOptions<"root">) => {
