...
export let item;
export let gridParams;
let classes = undefined;
export { classes as class };
export let activeClass = undefined;
export let previewClass = undefined;
...
const resizable = !gridParams.readOnly && item.resizable === undefined && item.resizable !== false;
...
function moving(event) {
    ...
    if (Math.abs(left - item.w * gridParams.itemSize.width) > gridParams.itemSize.width / 8 ||
