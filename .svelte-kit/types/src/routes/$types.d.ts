...
type LayoutRouteId = RouteId | "/" | "/(auth)/login" | "/(auth)/logout" | "/(auth)/register" | "/(protected)/admin" | "/(protected)/admin/user-management" | "/animes" | "/animes/[id]" | "/mangas" | "/mangas/[id]" | "/profile" | "/profile/animes-list" | "/search" | "/upload" | null
